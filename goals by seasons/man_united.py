...
plt.bar(df_man_united_per_season['Season'], df_man_united_per_season['TGS'], label='Total goals scored', color='#DA0106ff')
plt.bar(df_man_united_per_season['Season'], df_man_united_per_season['TGC'], label='Total goals conceded', color='#FFE600ff')
