...
total_shots = plt.bar(indexes, df_man_city_shots_accuracy['HS'], width=bar_width, label='Total shots', color='#002A5A')
total_shots_on_target = plt.bar([i + bar_width for i in indexes], df_man_city_shots_accuracy['HST'], width=bar_width, label='Total shots on target', color='#7AB2E1')
