...
total_shots = plt.bar(indexes, df_chelsea_shots_accuracy['TS'], width=bar_width, label='Total shots', color='#153D8A')
total_shots_on_target = plt.bar([i + bar_width for i in indexes], df_chelsea_shots_accuracy['TST'], width=bar_width, label='Total shots on target', color='#728AB9')
