...
total_shots = plt.bar(indexes, df_arsenal_shots_accuracy['TS'], width=bar_width, label='Total shots', color='#002A74ff')
total_shots_on_target = plt.bar([i + bar_width for i in indexes], df_arsenal_shots_accuracy['TST'], width=bar_width, label='Total shots on target', color='#DB0000ff')
