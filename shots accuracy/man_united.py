...
total_shots = plt.bar(indexes, df_man_united_shots_accuracy['HS'], width=bar_width, label='Total shots', color='#DA020E')
total_shots_on_target = plt.bar([i + bar_width for i in indexes], df_man_united_shots_accuracy['HST'], width=bar_width, label='Total shots on target', color='#FFE500')
